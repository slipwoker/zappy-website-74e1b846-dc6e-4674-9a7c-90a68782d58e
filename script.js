    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      inputs.forEach(function(input) {
        ...
        if (input.hasAttribute('minlength') && input.value.trim().length < parseInt(input.getAttribute('minlength'))) {
          showError(input, input.getAttribute('data-error-minlength') || 'Minimum length is ' + input.getAttribute('minlength') + ' characters');
          isValid = false;
        }
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '74e1b846-dc6e-4674-9a7c-90a68782d58e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '74e1b846-dc6e-4674-9a7c-90a68782d58e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '74e1b846-dc6e-4674-9a7c-90a68782d58e';
